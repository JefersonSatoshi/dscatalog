...
public class ProductServiceTests {
	...
	void setUp() throws Exception {  
		...
		Mockito.when(categoryRepository.getReferenceById(2L)).thenReturn(new Category(2L, "Electronics"));
	...
	@Test
	public void insetShouldCreateObject() {
	    ...
	    Assertions.assertEquals(dto.getCategories().size(), result.getCategories().size());
	...
	public void updateShouldReturnProductDTOWhenIdExists() {
	    ...
	    Mockito.verify(categoryRepository).getReferenceById(2L);
	}
